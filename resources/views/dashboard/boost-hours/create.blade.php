...
@section('title', __('Create Boost Hour'))
...
@section('breadcrumb-items')
    <li class="breadcrumb-item"><a href="{{ route('dashboard.promo-codes.index') }}">{{ __('Boost Hours') }}</a></li>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.boost-hours.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row p-5">
                        <h3>{{ __('Add New Boost Hour') }}</h3>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('multiplier') is-invalid @enderror" type="number"
                                step="any" id="multiplier" name="multiplier" value="{{ old('multiplier') }}" required
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Add Boost Hour') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->

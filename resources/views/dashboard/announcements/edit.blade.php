...
@section('title', __('Edit Annoucement'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.announcements.update', $annoucement->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" type="text" id="title"
                                ...
                                value="{{ old('title', $annoucement->title) }}" />
                            @error('title')
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('description') is-invalid @enderror" type="text" id="description"
                                ...
                                value="{{ old('description', $annoucement->description) }}" />
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Update Announcement') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->

...
@section('title', __('Restaurant Owners'))
...
@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ __('Restaurant Owners') }}</li>
@endsection
            ...
            <div class="card-header">
                @canany(['create user'])
                    <button class="add-new btn btn-primary waves-effect waves-light" data-bs-toggle="offcanvas"
                        ...
                        <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">{{ __('Add New Restaurant Owner') }}</span>
                    </button>
                @endcan
            </div>

...
@section('title', __('Admin Panel Users'))
...
@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ __('Admin Panel Users') }}</li>
@endsection
            ...
            <div class="card-header">
                @canany(['create user'])
                    <button class="add-new btn btn-primary waves-effect waves-light" data-bs-toggle="offcanvas"
                        ...
                        <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">{{ __('Add New Admin Panel User') }}</span>
                    </button>
                @endcan
            </div>
                        ...
                        @foreach ($users as $index => $user)
                            <tr>
                                ...
                                @canany(['delete user', 'update user', 'view user'])
                                    <td class="d-flex">
                                        @canany(['delete user'])
                                            {{-- Super admin accounts are protected from deletion here since this
                                                 page is the only place staff accounts live; regular admin accounts

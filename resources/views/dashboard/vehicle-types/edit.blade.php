                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                @foreach ($icons as $icon)
                                    ...
                                    <div class="icon-option border rounded p-2 text-center
                                        {{ $selectedIcon == $filename ? 'border-primary' : '' }}"
                                        data-name="{{ $filename }}" style="cursor:pointer; width:80px;">
                        ...
                        <div class="col-md-6 mb-4">
                            <label class="switch switch-square">
                                ...
                                <input type="checkbox" class="switch-input @error('is_delivery') is-invalid @enderror" id="is_delivery"
                                    name="is_delivery" {{ old('is_delivery', $vehicleType->is_delivery) == '1' ? 'checked' : '' }}/>
